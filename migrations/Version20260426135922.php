 ...
 */
final class Version20260426135922 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'delete relation ManyToMany between Menu and Allergene';
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu_allergene (menu_id INT NOT NULL, allergene_id INT NOT NULL, INDEX IDX_8A634DD1CCD7E912 (menu_id), INDEX IDX_8A634DD14646AB2 (allergene_id), PRIMARY KEY (menu_id, allergene_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
